"""
Color utilities for the userspace component.
...
from vega_common.utils.color_utils import (
    ...
    colors_are_similar, calculate_color_signature, calculate_color_distance,
    normalize_rgb_values, rgb_to_rgbcolor, handle_extreme_hsv
)
